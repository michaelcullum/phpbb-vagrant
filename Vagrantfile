...
php7devYamlPath = File.expand_path("./config.yaml")
afterScriptPath = File.expand_path("./scripts/customize.sh")
aliasesPath = File.expand_path("./.bashrc")
vhostPath = File.expand_path("./phpbb.conf")
...
#	end
	...
	#config.vm.provision "file", source: vhostPath, destination: "/etc/nginx/conf.d/phpbb.conf"
end
